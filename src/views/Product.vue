            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="product_img" alt />
                </div>
                <div class="product-thumbs">
                  <Carousel
                    ...
                    :items="3"
                  >
                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] === product_img ? 'active' : ''">
                      <img src="img/mickey1.jpg" alt />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] === product_img ? 'active' : ''">
                      <img src="img/mickey2.jpg" alt />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] === product_img ? 'active' : ''">
                      <img src="img/mickey3.jpg" alt />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[3])" :class="thumbs[3] === product_img ? 'active' : ''">
              ...
              <div class="col-lg-6">
                <div class="product-details text-left">
                  ...
                  <div class="quantity">
                    <router-link to="/shopping-cart"><a href="#" class="primary-btn pd-cart">Add To Cart</a></router-link>
                  </div>
                </div>
              </div>
            </div>
